...
| stories.md | Story patterns |
| args.md | Args patterns |
| addons.md | Addon patterns |
...
| File | Description |
|------|-------------|
| cli/index.md | Storybook CLI commands |
...
| File | Description |
|------|-------------|
| component-development.md | Component development |

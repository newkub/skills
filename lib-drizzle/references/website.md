...
Collection of official links and resources for Drizzle ORM and Drizzle Kit.
...
|---------|-----|-------------|
| **Get Started** | [orm.drizzle.team/docs/get-started](https://orm.drizzle.team/docs/get-started) | Quick start guides |
| **Schema** | [orm.drizzle.team/docs/schema-declaration](https://orm.drizzle.team/docs/schema-declaration) | Schema definition reference |
| **Queries** | [orm.drizzle.team/docs/select](https://orm.drizzle.team/docs/select) | Query API reference |
| **Relations** | [orm.drizzle.team/docs/relations](https://orm.drizzle.team/docs/relations) | Relations API |
| **Migrations** | [orm.drizzle.team/docs/kit-overview](https://orm.drizzle.team/docs/kit-overview) | Drizzle Kit documentation |
| **Guides** | [orm.drizzle.team/docs/guides](https://orm.drizzle.team/docs/guides) | Tutorials and guides |
...
| Resource | URL | Description |
|----------|-----|-------------|
| **Discord** | [discord.gg/drizzle](https://discord.gg/drizzle) | Chat with community |
| **GitHub Discussions** | [github.com/drizzle-team/drizzle-orm/discussions](https://github.com/drizzle-team/drizzle-orm/discussions) | Q&A and discussions |
| **GitHub Issues** | [github.com/drizzle-team/drizzle-orm/issues](https://github.com/drizzle-team/drizzle-orm/issues) | Bug reports and feature requests |
| **Stack Overflow** | [stackoverflow.com/questions/tagged/drizzle](https://stackoverflow.com/questions/tagged/drizzle-orm) | Tagged questions |

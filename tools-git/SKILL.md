---
name: git
description: Best practices สำหรับการใช้ Git ในการพัฒนาซอฟต์แวร์
goal: ให้นักพัฒนาใช้ Git อย่างมีประสิทธิภาพและเป็นไปตามมาตรฐาน
outcome: สามารถจัดการ source code, ทำงานร่วมกับทีม, และใช้ Git commands อย่างถูกต้อง
---

...
โครงสร้างโฟลเดอร์สำหรับ Cloud Platform Skills
...
ไฟล์เนื้อหาแนะนำและ best practices สำหรับ cloud platform
...
- `integration.md` - การเชื่อมต่อกับ services อื่นๆ
- `security.md` - ความปลอดภัยและ security best practices
...
- `setup-<cloud>.md` - Setup cloud platform
- `deploy-<cloud>.md` - Deploy ไปยัง cloud platform
- `configure-<service>.md` - Configure specific services

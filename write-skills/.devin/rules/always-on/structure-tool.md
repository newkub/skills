...
โครงสร้างโฟลเดอร์สำหรับ Development Tool Skills
...
- `setup-<tool>.md` - Setup tool
- `use-<tool>.md` - Use tool
- `configure-<tool>.md` - Configure tool

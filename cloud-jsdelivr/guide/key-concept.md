...
| Tag | Git tag หรือ npm tag | `vue@next`, `vue@beta` |
...
```html
<script src="https://cdn.jsdelivr.net/combine/npm/vue@3,npm/lodash@4/lodash.min.js"></script>
```
...
3. **Origin Cache**: Cache จาก npm/GitHub
...
สำหรับ package authors ที่จะ publish ไป npm:

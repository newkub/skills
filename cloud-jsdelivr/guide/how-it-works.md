...
jsDelivr เป็น Open Source CDN (Content Delivery Network) ฟรีสำหรับ developers ให้บริการส่งมอบ npm packages และ GitHub files ที่ optimized สำหรับการใช้งานบน web

## อะไรคือ jsDelivr?

jsDelivr เป็น CDN ที่เชี่ยวชาญในการส่งมอบ JavaScript libraries, CSS frameworks, และ static assets จาก:

- **npm registry** - กว่า 2.5 ล้าน packages
...
1. **Loading npm packages on web pages**
